...
<ul>
	<li>前端：js,vue</li>
	<li>后台：SpringMvc,mysql</li>
	<li>安卓：kotlin,Mvp,Rxjava,Retrofit,Dagger</li>
	<li>3D小程序：three.js,blender</li>	
</ul>

</p>
</p>
目前从事Android开发，偶尔抽空写一下前端后台，未来会向大数据方向发展，
如果有兴趣，可以加群嗷！！<br><br>
QQ群：830556582<br><br>
<div display="inline">
<h2>作品展示：</h2>
    <img src="<%=basePath %>images/gh_f211ccd8936f_430.jpg"  width="120" height="120"  alt="1232"/>
</div>
      </div>
    </div>
  </div>
